...
@Component({
  selector: 'az-edit-supplier-product',
  standalone: true,
  imports: [
    FormsModule,
    CommonModule,
  ...
  templateUrl: './edit-supplier-product.component.html',
  styleUrl: './edit-supplier-product.component.scss'
})
export class EditSupplierProductComponent {
supplierId: number;
