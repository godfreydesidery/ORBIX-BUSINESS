...
@Component({
  selector: 'az-view-supplier-products',
  standalone: true,
  imports: [
    FormsModule,
    CommonModule,
  ...
  templateUrl: './view-supplier-products.component.html',
  styleUrl: './view-supplier-products.component.scss'
})
export class ViewSupplierProductsComponent {
supplierId: number;
