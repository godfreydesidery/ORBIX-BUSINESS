...
@Component({
  ...
  styleUrl: './lpo-report.component.scss'
})
export class LpoReportComponent {
documentHeader! : any
  ...
  async getStockLogByDate(from : Date | string | null, to : Date | string | null) {
    ...
    await this.http.post<ILpoReport[]>(API_URL+'/lpos/get_lpo_report_by_dates', args, options)
        .toPromise()
        .then(
          data => {
