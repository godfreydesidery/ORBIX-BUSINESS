...
@Component({
  ...
  templateUrl: './parking-discounts.component.html',
  styleUrl: './parking-discounts.component.scss'
})
export class ParkingDiscountsComponent {
  ...
  async getAllCheckedInParkings() {
    ...
    await this.http.get<IParking[]>(API_URL + '/parkings/get_all_with_discounts', options)
      .toPromise()
      .then(
        data => {
          data?.reverse()
