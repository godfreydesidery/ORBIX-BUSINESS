...
@Component({
  ...
  templateUrl: './my-closed-jobs.component.html',
  styleUrl: './my-closed-jobs.component.scss'
})
export class MyClosedJobsComponent {
  documentHeader! : any
        ...
        ngOnInit(){
          this.getAllCheckedInMaintenancesWithClosedJobsAndMine()   
        ...
        async getAllCheckedInMaintenancesWithClosedJobsAndMine(){
          let options = {
            headers: new HttpHeaders().set('Authorization', 'Bearer '+this.auth.user.access_token)
          }
          this.maintenances = []
      
          await this.http.get<IMaintenance[]>(API_URL+'/maintenances/get_all_checked_in_with_closed_jobs_and_mine', options)
          .toPromise()
          .then(
            data => {
              var sn = 1
      ...
      async createOrLoadMaintenanceJobCard(maintenanceId: any) {
        ...
        await this.http.post<IMaintenanceJobCard>(API_URL + '/maintenances/create_maintenance_job_card_and_closed_and_mine', maintenance, options)
          .toPromise()
          .then(
            data => {
          ...
          async loadIssue(id : any){
            ...
            .then(
              data => {
                ...
                this.issueComments = data!.comments
                console.log(data)
              }
            )
            .catch(
