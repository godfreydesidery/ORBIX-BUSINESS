...
@Component({
  ...
  templateUrl: './select-bond-zone.component.html',
...
export class SelectBondZoneComponent {
  ...
  ngOnInit() {
    ...
    this.getAllCompanyActiveBondItemTypes()
  }
  ...
  async printReleaseNote(id: any) {
    await this.getBondItemGoodRelease(id)
    await this.printGatePassRcpt(this.billItems, this.bondItemGoodReleaseNo, 0, id)
  }
        ...
        },
        {
          ...
          table: {
            ...
            body: [
              ...
              [{ text: 'Issued At: ' + this.bondItemGoodReleaseReleaseDate, alignment: 'left', fontSize: 9, bold: true }],
