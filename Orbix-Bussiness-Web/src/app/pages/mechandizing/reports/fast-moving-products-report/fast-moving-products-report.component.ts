...
@Component({
  selector: 'az-fast-moving-products-report',
  standalone: true,
  imports: [
    FormsModule,
    CommonModule,
  ...
  templateUrl: './fast-moving-products-report.component.html',
  styleUrl: './fast-moving-products-report.component.scss'
})
export class FastMovingProductsReportComponent {
documentHeader! : any
  ...
  async getFastMovingProductsByDate(from : Date | string | null, to : Date | string | null) {
    ...
    await this.http.post<IFastMovingProducts[]>(API_URL+'/sales_reports/get_fast_moving_products_report_by_dates', args, options)
        .toPromise()
        .then(
          data => {
