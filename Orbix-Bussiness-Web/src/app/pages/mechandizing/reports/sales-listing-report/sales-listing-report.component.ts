...
@Component({
  selector: 'az-sales-listing-report',
  standalone: true,
  imports: [
    FormsModule,
    CommonModule,
  ...
  templateUrl: './sales-listing-report.component.html',
  styleUrl: './sales-listing-report.component.scss'
})
export class SalesListingReportComponent {
documentHeader! : any
  ...
  printReport = async () => {
    ...
    var header = ''
    var footer = ''
    var title  = 'Sales Listing Report'
