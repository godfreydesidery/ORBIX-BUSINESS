...
//	}
	...
	public ResponseEntity<ApiCustomResponse>activate(
			...
			HttpServletRequest request){
		URI uri = URI.create(ServletUriComponentsBuilder.fromCurrentContextPath().path("/orbix-business-api/users/activate").toUriString());
		return ResponseEntity.created(uri).body(userService.activateUser(userRequest, request));
	}
	...
	public ResponseEntity<ApiCustomResponse>deactivate(
			@RequestBody UserRequestDTO userRequest,
			HttpServletRequest request){
		URI uri = URI.create(ServletUriComponentsBuilder.fromCurrentContextPath().path("/orbix-business-api/users/deactivate").toUriString());
