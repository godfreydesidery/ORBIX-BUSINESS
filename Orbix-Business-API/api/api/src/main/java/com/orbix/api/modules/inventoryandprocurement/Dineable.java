...
@NoArgsConstructor 
@AllArgsConstructor
@Table(name = "dineables", uniqueConstraints = { @UniqueConstraint(columnNames = {"code", "company_id"}), @UniqueConstraint(columnNames = {"name", "company_id"})})
public class Dineable {
	@Id
	...
	@JsonIgnoreProperties("dineables")
